...
from SigmaMusic.misc import SUDOERS
from SigmaMusic.utils.database import add_sudo, remove_sudo
from SigmaMusic.utils.decorators.language import language
from SigmaMusic.utils.extraction import extract_user
from SigmaMusic.utils.inline import close_markup
...
async def sudoers_list(client, message: Message, _):
    if message.from_user.id not in SUDOERS:
        return await message.reply_text("💔 <b>ᴏᴡɴᴇʀs:</b>\n1➤ <a href='https://t.me/iTzViR99'>🇷🇺⛦°╰𝐑֟֟𝐂╯°⛦ ➣🇵ιყυʂԋ⏤͟͟⛦⃕͜🇮🇳🇳</a>",
