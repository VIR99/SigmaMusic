...
from SigmaMusic.utils.decorators.admins import ActualAdminCB
from SigmaMusic.utils.decorators.language import language, languageCB
from SigmaMusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from SigmaMusic.utils.inline.start import private_panel
...
async def gib_repo(client, CallbackQuery, _):
    await CallbackQuery.edit_message_media(
        InputMediaVideo("https://te.legra.ph/file/678a0aa16416d550a9b77.mp4"),
